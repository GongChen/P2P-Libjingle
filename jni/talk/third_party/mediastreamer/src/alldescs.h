...
extern MSFilterDesc ms_au_read_desc;
extern MSFilterDesc ms_au_write_desc;
extern MSFilterDesc ms_v4m_desc;
extern MSFilterDesc ms_osx_gl_display_desc;
